...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_225_275(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C, KC_V,         KC_B, KC_N,         KC_M, KC_COMM, KC_DOT,           KC_RSFT, KC_SLSH,    KC_P1, KC_P2,   KC_P3,   KC_PPLS,
        KC_LCTL, KC_LGUI, KC_LALT,       LT(1,KC_SPC),       LT(1,KC_SPC), MO(1),                  KC_RALT, KC_RGUI, KC_RCTL,    KC_P0, KC_PDOT, KC_PENT, KC_PENT
    ),
